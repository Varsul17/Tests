...
Receives 5 parameters:
    1.  matrix, the NxN matrix that method is being performed on.
    2.  vector_b, vector of solution. 
    3.  vector_0,  the desired initial guess.
...
def jacobi_iterative(matrix, vector_b, vector_0, TOL=1e-16, max_Iteration=200):
    ...
    if is_diagonally_dominant(matrix):
        ...
        matrix = DominantDiagonalFix(matrix)
        # print('Matrix is not diagonally')
        # return
    print(matrix)
...
if __name__ == "__main__":
    ...
    A = np.array([[6, 4, 5], [12, 8, 10], [18, 12, 15]])
    b = np.array([10, 20, 30])
